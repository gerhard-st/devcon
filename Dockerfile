...
RUN dnf -y make git ksh gcc-c++ flex byacc bison rpm-build openssl python3 glibc-devel flex-devel libaio-devel zlib-devel elfutils-libelf-devel kernel-headers kernel-devel
